...
dataout,dataout_,dataout_t,etcout = DataLoadingMain(time(),1,toyopt,0,False,"")
...
#    print(candidatesf)
    ...
    rotI,rotf_real = inv_exploit_symmetries(expand_nbhd_I[0],real_f0,real_i0) # I vector has been decompressed

    ##we also need to undo the "scaling to distinguish" factor we did on the y in Training.py
    rotf_real = (1,1,1/10,1/10,1/10)*rotf_real
    rotf_cand = (1,1,1/10,1/10,1/10)*rotf_cand
#    print(rotf_cand)

#    print("\nTHESE SHOULD MATCH...")
#    print("true Ivec:             ", real_I0)
#    print("rotated-back Ivec:     ", np.round(np.real(rotI),decimals=3))
