...
def symbI(L, ab, cde ):
    ...
    (2*(b + b**3)*c*d*L1 + b*((1 + b**2)*c**2 + 3*d**2)*L2 + a**3*d*(d*L1 + 2*c*L2) - ((1 + b**2)*c**2 + (1 - 2*b**2)*d**2)*L3 - a**2*(b*(4*c*d*L1 + 2*c**2*L2 - 3*d**2*L2) + (-2*c**2 + d**2)*L3) + a*(3*(1 + b**2)*c**2*L1 + (1 - 2*b**2)*d**2*L1 +
        2*c*d*(L2 - 2*b**2*L2 + 3*b*L3)))/((1 + a**2 + b**2)**(5/2)*np.sqrt(L1**2 + L2**2 + L3**2)), ##
    ((b + b**3)*(d**2 + c*e)*L1 + b*d*(c + b**2*c + 3*e)*L2 + a**3*(d*e*L1 + d**2*L2 + c*e*L2) - d*(c + b**2*c + e - 2*b**2*e)*L3 - a**2*(2*b*(d**2 + c*e)*L1 + b*d*(2*c - 3*e)*L2 + d*(-2*c + e)*L3) + a*(3*(1 + b**2)*c*d*L1 - (-1 + 2*b**2)*d*(e*L1 + d*L2) +
        3*b*d**2*L3 + c*e*(L2 - 2*b**2*L2 + 3*b*L3)))/((1 + a**2 + b**2)**(5/2)* np.sqrt(L1**2 + L2**2 + L3**2)), ##
