...
#directoryin = str(os.getcwd()+"/Data/YUP/YUP")                             ##RealDataProcessing.nb
#directoryin = str(os.getcwd()+"/Data/Real/Real")                            ##RealDataProcessing.nb
#directoryin = str(os.getcwd()+"/Data/testme/testme")                          ##RealDataProcessing.nb
#directoryin = str(os.getcwd()+"/Data/please/please")                          ##RealDataProcessing.nb
#directoryin = str(os.getcwd()+"/Data/realreal/realreal")                        ##RealDataProcessing.nb
...
if directoryin == str(os.getcwd()+"/Data/Synth"):
    ...
    real_f  = np.array(ast.literal_eval(open(directoryin+"_f.txt", "r").read()))[thisf]
...
if directoryin == str(os.getcwd()+"/Data/MultiPixel"):
